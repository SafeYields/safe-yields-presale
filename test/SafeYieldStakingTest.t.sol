...
contract SafeYieldStakingTest is SafeYieldBaseTest {
    ...
    function testAutoStakeForShouldFailIfCallerIsNotPresale() public {
        vm.prank(ALICE);
        vm.expectRevert(SafeYieldStaking.SYST__ONLY_PRESALE.selector);
    ...
    function testStakeSafeTokens() public startEndPresale {
        ...
        assertEq(staking.getUserStake(ALICE).stakeAmount, 2_000e18);
    }

    function testStakeSafeTokensFor() public startEndPresale {
