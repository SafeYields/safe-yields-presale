...
contract FeeHandler is ReentrancyGuard, RoleModule, OracleModule, BasicMulticall {
    ...
    function getOutputAmount(
        ...
        uint256 maxFeeTokenAmount =
            _getMaxFeeTokenAmount(feeToken, buybackToken, batchSize, feeTokenPrice, buybackTokenPrice);
    ...
    function _getMaxFeeTokenAmount(address feeToken, address buybackToken, uint256 batchSize)
        internal
        view
        returns (uint256)
    {
