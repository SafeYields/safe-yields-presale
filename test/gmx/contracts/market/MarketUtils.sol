...
library MarketUtils {
        ...
        returns (GetNextFundingAmountPerSizeResult memory)
    {
        ...
        console.log("Duration:", cache.durationInSeconds);
        ...
        console.log("PerSec", result.fundingFactorPerSecond);
    ...
    function getSecondsSinceFundingUpdated(DataStore dataStore, address market) internal view returns (uint256) {
        ...
        console.log("Timestamp", Chain.currentTimestamp());
        console.log("updatedAt", updatedAt);

        return updatedAt - Chain.currentTimestamp();
    }
    ...
    function getNextCumulativeBorrowingFactor(
        ...
        console.log("getSecondsSinceCumulativeBorrowingFactorUpdated");
        ...
        returns (uint256)
    {
        ...
        return distributedAt - Chain.currentTimestamp();
    }
