...
library CallbackUtils {
    ...
    function afterShiftExecution(bytes32 key, Shift.Props memory shift, EventUtils.EventLogData memory eventData)
        internal
    {
    ...
    function afterShiftCancellation(bytes32 key, Shift.Props memory shift, EventUtils.EventLogData memory eventData)
        internal
    {
        if (!isValidCallbackContract(shift.callbackContract())) return;
    ...
    function afterGlvDepositExecution(
        ...
        try IGlvDepositCallbackReceiver(glvDeposit.callbackContract()).afterGlvDepositExecution{
            gas: glvDeposit.callbackGasLimit()
        }(key, glvDeposit, eventData) { } catch {
    ...
    function afterGlvDepositCancellation(
        ...
        try IGlvDepositCallbackReceiver(glvDeposit.callbackContract()).afterGlvDepositCancellation{
            gas: glvDeposit.callbackGasLimit()
        }(key, glvDeposit, eventData) { } catch {
    ...
    function afterGlvWithdrawalExecution(
        ...
        try IGlvWithdrawalCallbackReceiver(glvWithdrawal.callbackContract()).afterGlvWithdrawalExecution{
            gas: glvWithdrawal.callbackGasLimit()
        }(key, glvWithdrawal, eventData) { } catch {
    ...
    function afterGlvWithdrawalCancellation(
        ...
        try IGlvWithdrawalCallbackReceiver(glvWithdrawal.callbackContract()).afterGlvWithdrawalCancellation{
            gas: glvWithdrawal.callbackGasLimit()
        }(key, glvWithdrawal, eventData) { } catch {
