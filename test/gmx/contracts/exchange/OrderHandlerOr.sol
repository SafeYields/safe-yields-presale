...
contract OrderHandlerOr is IOrderHandler, BaseOrderHandler {
    ...
    function createOrder(address account, IBaseOrderUtils.CreateOrderParams calldata params)
        ...
        returns (bytes32)
    {
        console.log("CreateOrder-OrderHandler");
    ...
    function updateOrder(
        ...
        OrderEventUtils.emitOrderUpdated(eventEmitter, key, order);
    }
    ...
    function _handleOrderError(bytes32 key, uint256 startingGas, bytes memory reasonBytes) internal {
        ...
        if (
            ...
            order.isFrozen() || (!isMarketOrder && errorSelector == Errors.EmptyPosition.selector)
