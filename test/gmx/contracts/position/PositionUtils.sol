...
library PositionUtils {
    ...
    function updateFundingAndBorrowingState(
        ...
        console.log("After Funding State");
        ...
        console.log("updateCumulativeBorrowingFactor1");
        ...
        console.log("updateCumulativeBorrowingFactor2");
    }
        ...
        returns (int256, int256, uint256, uint256)
    {
        ...
        console.log("after priceImpactUsd");
        ...
        console.log("priceImpactUsd", uint256(priceImpactUsd));
        ...
        console.log("sizeDeltaInTokens.toUint256()", sizeDeltaInTokens.toUint256());
